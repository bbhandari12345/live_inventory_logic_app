...
from LiveInventoryFetcher.common_utils.db_utils import generate_sql_get_disabled_vendors
from LiveInventoryFetcher.common_utils.db_queries import QUERY_DELETE_OLD_RECORD_INVENTORY
import logging
