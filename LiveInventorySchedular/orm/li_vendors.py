from LiveInventorySchedular.common_utils.db_queries import QUERY_UPDATE_LAST_MOD_VENDORS, \
...
from LiveInventorySchedular.schemas.schemas import VendorsSchema
import logging
